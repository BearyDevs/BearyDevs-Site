...
export const LennyFace = () => {
  ...
  return (
    <div
      // className="flex items-center absolute top-2.5 right-8 select-none not-sr-only"
      className="flex items-center absolute top-14 left-1/2 -translate-x-1/2 translate-y-8 select-none not-sr-only opacity-70"
      onClick={handleClick}
    >
